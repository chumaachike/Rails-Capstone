...
# 📖 Glacier <a name="about-project"></a>

**Glacier** is a mobile web application to manage budget.
...
using HTTPS:
```sh
  git clone https://github.com/chumaachike/Rails-Capstone.git
  cd Rails-Capstone
```

using an SSH key:
```sh
  git clone git@github.com:chumaachike/Rails-Capstone.git
  cd Rails-Capstone
```

using GitHub CLI:
```sh
  git clone gh repo clone chumaachike/Rails-Capstone
  cd Rails-Capstone
```
